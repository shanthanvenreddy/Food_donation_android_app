...
public class OrphanageSelectLoc extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_orphanage_select_loc);
		
		Intent ii=getIntent();
        name=getIntent().getExtras().getString("name");
        System.out.println("orphanage select location name "+name);
		...
		list.add(cc.getString(cc.getColumnIndex("address")));
          ...
          submit.setOnClickListener(new OnClickListener(){
				...
				public void onClick(View v) {
		 			// TODO Auto-generated method stub
					Intent ad= new Intent(OrphanageSelectLoc.this,OrphanageViewDonor.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.orphanage_select_loc, menu);
		return true;
	}
