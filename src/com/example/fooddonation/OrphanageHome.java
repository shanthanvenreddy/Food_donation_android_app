...
public class OrphanageHome extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		password.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				Intent ad= new Intent(OrphanageHome.this,ChangePassword.class);
		...
		logout.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
	 			// TODO Auto-generated method stub
				Intent ad= new Intent(OrphanageHome.this,MainActivity.class);
				startActivity(ad);
								}
        	 });
		...
		donor.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
	 			// TODO Auto-generated method stub
				Intent ad= new Intent(OrphanageHome.this,OrphanageSelectLoc.class);
				ad.putExtra("name", name);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.orphanage_home, menu);
		return true;
	}
